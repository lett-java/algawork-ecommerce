...
insert into cliente (id, nome) values (3, "Lucas Floriano");
...
insert into pagamento (pedido_id, status, numero_cartao, dtype) values (2, 'PROCESSANDO', '1234', 'PagamentoCartao');
